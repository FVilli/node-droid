export class GitCommands {
  static checkout(branch: string): string {
    return `git checkout ${branch}`;
  }
  static fetch(): string {
    return 'git fetch origin';
  }
  static createBranch(branch: string): string {
    return `git checkout -b ${branch}`;
  }
  static commit(msg: string): string {
  ...
  static push(branch: string): string {
    return `git push origin ${branch}`;
  }
  static clone(remote: string): string {
    return `git clone ${remote} code`;
  }
